      ...
      <View>
        <Picker
            ...
            >
              ...
              return (< Picker.Item label={Object.values(item)[3]} value={index} key={index} />);  /// ถ้าเพิ่ม document ต้องแก้ให้เลือกที่ model car
              })} 
            </Picker>
            <TouchableHighlight>
            ...
            <Button title="OK" onPress={() => this.SetCar(this.state.cardetail).bind(this)}/>
            <View>
