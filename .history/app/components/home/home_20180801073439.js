...
import {Input, Item , Content , Form} from 'native-base'
    ...
    <Text>{this.state.currentSpeed.toFixed(1)}</Text>
      ...
      <View style={{marginRight :15}}>
        ...
        <Form style={{flexDirection:'column'}}>
          <Text>Fueluse: </Text>
          <Item regular style={{paddingHorizontal:40 }}>
            <Input 
             onChangeText={(fueluse) => this.setState({fueluse})}
             value={this.state.fueluse}
            />
          </Item>
          <Text>{this.props.CarDetail.FuelCapacity} L</Text>
          </Form>
        </View>
