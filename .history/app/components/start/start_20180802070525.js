...
export  class Start extends Component {
  ...
  addOne() {
    ...
    this.setState({currentSpeed: (currentSpeed + 0.1) * 18/5 });
  ...
  //     }, 0.1);
    ...
    <Text>Speed: {this.state.currentSpeed.toFixed(1) * 18/5} KM/H</Text>
      ...
      <Text>Distance: {this.state.sum.toFixed(1) / 1000} KM</Text>  
