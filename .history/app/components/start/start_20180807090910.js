...
export  class Start extends Component {
  constructor(props){
    ...
    this.accetimer = null;
    this.addacce = this.addacce.bind(this);
    // this.stopacce = this.stopacce.bind(this);
  }
  addOne() {
    ...
    if(this.state.acceleration < 100){
    this.addacce()
    }
  }
  ...
  addacce(){
    ...
    clearTimeout(this.accetimer);
    
      this.setState({acceleration:this.state.acceleration + 5 });
       this.accetimer = setTimeout(this.addacce, 5000);
  ...
  //     }, 0.1);
    ...
    <Text>Speed: {speed.toFixed(1)} KM/H</Text>
      <TouchableOpacity onPressIn={this.addOne.bind(this)}  onPressOut={this.stopTimer.bind(this)} onLongPress={this.setState({acceleration:this.state.acceleration +5})}  >
