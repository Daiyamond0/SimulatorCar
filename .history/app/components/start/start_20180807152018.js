...
export  class Start extends Component {
  ...
  if(this.state.acceleration <= 100){
    ...
    // else{
  //     setTimeout(() => {
  //       this.setState({acceleration: 100 });
  //      }, 1000)
  //      if(this.state.acceleration >= 60){
  //        this.ref.push({
  //     speedId : this.state.speedId,
  //     distance :currentSpeed,
  //     totalfueluse:totalfueluse.toFixed(1) + 2 
  //   })
  //   this.setState({
  //     speedId: this.state.speedId + 1,
  //     sum : (sum / 1000) +2,
  ...
  stopTimer() {
    ...
    setTimeout(() => {
      this.setState({acceleration:this.state.acceleration - this.state.acceleration})
     }, 100)
