...
export  class Start extends Component {
  ...
  addOne() {
    if(this.state.currentSpeed.toFixed(0) < this.props.CarDetail.MaxSpeed -1){
    ...
    this.setState({
      ...
      sum : sum / 1000,
      // fuelusetotal : (sum /1000)/this.props.CarDetail.FuelConsumption,
      fueluse: this.props.CarDetail.FuelCapacity - (sum /1000)/this.props.CarDetail.FuelConsumption
    }); 
  }
  else{
    this.setState({currentSpeed:this.props.CarDetail.MaxSpeed})
  }
  }
  stopTimer() {
    const currentSpeed = this.state.currentSpeed ;
  ...
  //     }, 0.1);
      ...
      const speed = this.state.currentSpeed.toFixed(1)
    ...
    <Text>Speed: {speed} KM/H</Text>
      ...
      <View style={{flexDirection:'row',margin:10}}> 
        ...
        <View style={{padding:15 , flexDirection:'row' , alignItems:'center'}}> 
          ...
          <Text>Fueluse: {this.state.fueluse.toFixed(0)} </Text> 
