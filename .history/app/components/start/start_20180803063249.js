...
export  class Start extends Component {
  ...
  componentDidMount(){
    ...
    // TimerMixin.setInterval(() => {
    //  const distance = this.state.sum;
    // const fuelcons = this.props.CarDetail.FuelConsumption;
    // if(distance % fuelcons== 0 && distance != 0){
    //   this.setState({fueluse:this.state.fueluse - 1})
    // }
    //   }, 200);
    this.totalfuel();
  ...
  totalfuel(){
    const x = this.state.sum/this.props.CarDetail.FuelConsumption
    console.log(x)
  }
      ...
      <View style={{flexDirection:'row',margin:10}}> 
        ...
        <View style={{padding:15 , flexDirection:'row' , alignItems:'center'}}> 
          ...
          <View style={styles.modalContent}>
            ...
            <Text>Total Fueluse:{totalfueluse.toFixed(1)}{this.setState({fuelusetotal:[...totalfueluse.toFixed(1),totalfueluse.toFixed(1)]})}</Text>
