...
export  class Start extends Component {
  ...
  addOne() {
    ...
    this.setState({
      ...
      fueluse: this.props.CarDetail.FuelCapacity - (sum.toFixed(0) /1000)/this.props.CarDetail.FuelConsumption
    }); 
  }
  else{
    const currentSpeed = this.state.currentSpeed ;
    ...
    this.setState({
      ...
      sum : sum / 1000,
      // fuelusetotal : (sum /1000)/this.props.CarDetail.FuelConsumption,
      fueluse: this.props.CarDetail.FuelCapacity - (parseInt(sum) /1000)/this.props.CarDetail.FuelConsumption
    }); 
  }
  ...
  fuelUse(){
    ...
    this.setState({fueluse:parseInt(x)});
    ...
    <Text>Speed: {speed.toFixed(1)} KM/H</Text>
      ...
      <View style={{flexDirection:'row',margin:10}}> 
        ...
        <View style={{padding:15 , flexDirection:'row' , alignItems:'center'}}> 
          ...
          <Text>Fueluse: {parseInt(this.state.fueluse)} </Text> 
