...
export  class Start extends Component {
  ...
  componentDidMount(){
    ...
    if(distance.toFixed(0) % fuelcons== 0.0 && distance != 0.0){
      this.setState({fueluse:this.state.fueluse - 1})
    }
      }, 200);
  ...
  //     }, 0.1);
      ...
      const totalfueluse = this.state.sum.toFixed(0)/this.props.CarDetail.FuelConsumption
      return (
    ...
    <Text>Speed: {speed.toFixed(1)} KM/H</Text>
      ...
      <Text>Distance: {this.state.sum.toFixed(0.1)} KM</Text>  
