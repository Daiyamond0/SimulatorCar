...
export  class Start extends Component {
  ...
  addacce(){
    ...
    if(this.state.acceleration < 100){
      ...
      this.accetimer = setTimeout(this.accetimer, 5000);
    }
  }
  stopTimer() {
    const currentSpeed = this.state.currentSpeed ;
  ...
  //     }, 0.1);
    ...
    <Text>Speed: {speed.toFixed(1)} KM/H</Text>
      <TouchableOpacity onPressIn={this.addOne.bind(this)&&this.addacce.bind(this)}  onPressOut={this.stopTimer.bind(this)}  >
