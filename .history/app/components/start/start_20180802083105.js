...
export  class Start extends Component {
  ...
  addOne() {
    const currentSpeed = this.state.currentSpeed.toFixed(1) ;
    clearTimeout(this.timer);
    this.setState({currentSpeed: currentSpeed + 0.1 });
    this.setState({arrVar:[...this.state.arrVar, currentSpeed]});
    this.timer = setTimeout(this.addOne.bind(this), 0.1);
  ...
  stopTimer() {
    ...
    this.setState({currentSpeed: currentSpeed - 0.1 });
    this.setState({arrVar:[...this.state.arrVar, currentSpeed]});
    this.timer = setTimeout(this.stopTimer.bind(this), 0.1);
    }
  ...
  //     }, 0.1);
    ...
    <Text>Speed: {this.state.currentSpeed * 3.6} M/S</Text>
