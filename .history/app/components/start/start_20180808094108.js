...
export  class Start extends Component {
  ...
  if(this.state.acceleration > 0 || this.state.acceleration <= 100){
    console.log('eiei')
  }
}
  stopTimer() {
  ...
  //     }, 0.1);
    ...
    <Text>Speed: {speed.toFixed(1)} KM/H</Text>
      ...
      <TouchableOpacity onPressIn={this.addOne.bind(this)}   onPressOut={this.stopTimer.bind(this)} onLongPress={this.generateRandomNumber.bind(this)}>
