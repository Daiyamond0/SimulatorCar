...
export  class Start extends Component {
  ...
  //     }, 0.1);
    ...
    <Text>Speed: { this.state.currentSpeed<this.props.CarDetail.MaxSpeed ? this.props.CarDetail.MaxSpeed : speed.toFixed(1)} KM/H</Text>
      ...
      <View style={{flexDirection:'row',margin:10}}> 
        ...
        <View>
           ...
           <Text>MaxSpeed: {this.props.CarDetail.MaxSpeed} </Text>
        </View>
