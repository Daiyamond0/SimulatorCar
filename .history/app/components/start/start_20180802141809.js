    ...
    <Text>Speed: {speed.toFixed(1)} KM/H</Text>
      ...
      <View style={{flexDirection:'row',margin:10}}> 
        ...
        <View style={{padding:15 , flexDirection:'row' , alignItems:'center'}}> 
          ...
          <Text>Fueluse: { this.state.sum.toFixed(0)% this.props.CarDetail.FuelConsumption!==0 ?  this.state.fueluse  : this.setState({fueluse:this.state.fueluse - 1})} </Text>
