...
export  class Start extends Component {
  ...
  fuelUse(totalfueluse){
    ...
    this.setState({fueluse: parseInt(x) + parseInt(totalfueluse)*2});
  ...
  //     }, 0.1);
      ...
      fueluse -= this.state.sum/this.props.CarDetail.FuelConsumption
    ...
    <Text>Speed: {speed.toFixed(1)} KM/H</Text>
      ...
      <View style={{flexDirection:'row',margin:10}}> 
        ...
        <View style={{padding:15 , flexDirection:'row' , alignItems:'center'}}> 
          ...
          <Text>Fueluse: {this.fuelUse.bind(this) == true ? fueluse + totalfueluse:fueluse} </Text> //////
