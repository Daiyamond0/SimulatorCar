...
export  class Start extends Component {
  ...
  fuelUse(){
    ...
    this.setState({ isModalVisible: !this.state.isModalVisible });
    const x  = this.state.fuelusemodal + this.state.sum/this.props.CarDetail.FuelConsumption;
  ...
  //     }, 0.1);
      ...
      const fueluse = this.state.fueluse - this.state.sum/this.props.CarDetail.FuelConsumption
      console.log(totalfueluse)
      return (
