...
import { createStackNavigator } from '../../../AppData/Local/Microsoft/TypeScript/2.9/node_modules/@types/react-navigation';
...
export default class HomeScreen extends Component {
  constructor(){
    ...
    this.ref = firebaseService.firestore().collection('Holds');
    this.timer = null;
